...
public class returnBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 190, 220, -1));

        jTextField4.setBackground(new java.awt.Color(153, 204, 255));
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 240, 220, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 150, -1, -1));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/adminIcons - Copy/icons8_Book_26px.png"))); // NOI18N
        jLabel5.setText("Return Book Panel");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 20, -1, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/undraw_building_websites_i78t.png"))); // NOI18N
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, -90, 930, 670));
...
try
{
    ...
    ResultSet rs;
            rs = new st.executeQuery("select * from issue where bookID ='"+bookID+"' and studentID='"+studentID+"'");
    if(rs.next())
    {
...
catch(Exception e)
{
    ...
    private static class JOptionPane {
        ...
        private static void showMessageDialog(Object object, String connection_error) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }

        private static void showMessageDIalog(Object object, String book_is_not_issued_to_this_studentID) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
